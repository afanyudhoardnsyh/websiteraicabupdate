...
<head>
    ...
    <link rel="stylesheet" href="css/styleunduh.css">
...
<body>
    ...
    <img src="image/OFC_WHITE Logo Raicab.webp" alt="Raimuna Cabang III Kota Depok">
        ...
        <span id="close-menu-btn" class="material-symbols-outlined">close</span>
            ...
            <li><a href="mediaunduh.php" class="active">MEDIA UNDUH</a></li>
            ...
            <div class="serv-content">
                <div class="card">
                    ...
                    <a href="pdf/SERTIFIKAT.pdf" download>
                        ...
                        <p>Silahkan tekan icon diatas untuk mengunduh <span>Surat Edaran</span></p>
                    </div>
                </div>
                <div class="card">
                    <div class="box">
                    <a href="pdf/SERTIFIKAT.pdf" download>
                        ...
                        <p>Silahkan tekan icon diatas untuk mengunduh <span>Juklak dan Juknis</span></p>
                    </div>
                </div>
                <div class="card">
                    <div class="box">
                    <a href="pdf/SERTIFIKAT.pdf" download>
                        ...
                        <p>Silahkan tekan icon diatas untuk mengunduh <span>SGM </span></p>
                    </div>
                </div>
            </div>
        </div>
