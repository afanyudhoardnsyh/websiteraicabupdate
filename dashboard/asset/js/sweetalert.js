...
document.getElementById("deleteA1").addEventListener("click", (e) => {
    ...
    if (result.isConfirmed) {
        document.location.href="/WebsiteRaicabUpdate/dashboard/berkas/delete/deleteA1.php"
    }
    });
})
...
document.getElementById("deleteA2").addEventListener("click", (e) => {
    ...
    if (result.isConfirmed) {
        document.location.href="/WebsiteRaicabUpdate/dashboard/berkas/delete/deleteA2.php"
    }
    });
})
...
document.getElementById("deleteA3").addEventListener("click", (e) => {
    ...
    if (result.isConfirmed) {
        document.location.href="/WebsiteRaicabUpdate/dashboard/berkas/delete/deleteA3.php"
    }
    });
})