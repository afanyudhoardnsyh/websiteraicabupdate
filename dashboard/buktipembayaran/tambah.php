            ...
            <div class="form first">
                <div class="details personal">
                    <div class="fields">
                        ...
                        <div class="input-field">
                            <label>Nominal</label>
                            <input type="number" name="nominal" id="nominal" placeholder="Masukkan Nominal Pembayaran" required readonly>
                        </div>
                ...
                <div class="details ID">
                    ...
                    <button type="submit" class="nextBtn" name="submit">Save Changes</button>
                </div>
        </form>
        </div>
    </div>
