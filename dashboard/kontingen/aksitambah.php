...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $bpjs = $target_dir_bpjs . basename($_FILES['bpjs']['name']);
            ...
            if ((move_uploaded_file($_FILES['sfh']['tmp_name'], $sfh)) &&
                ...
                $sql = "INSERT INTO unsur_kontingen (nama, ttl, kategori, kwarran, jenis_kelamin, nohp, ukuran_kaos, golongan, sfh, bpjs) VALUES ('$nama', '$ttl', '$kategori', '$kwarran', '$jk', '$nohp', '$ukkaos', '$golongan', '$sfh', '$bpjs')";
