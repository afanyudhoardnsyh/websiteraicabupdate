...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $bpjs = $target_dir_bpjs . basename($_FILES['bpjs']['name']);
            ...
            if ((move_uploaded_file($_FILES['bpjs']['tmp_name'], $bpjs))) {
                ...
                $sql = "INSERT INTO unsur_kontingen (name, ttl, kategori, kwarran, jenis_kelamin, nohp, ukuran_kaos, golongan, bpjs) VALUES ('$name', '$ttl', '$kategori', '$kwarran', '$jk', '$nohp', '$ukkaos', '$golongan', '$bpjs')";
