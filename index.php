...
<body>
    ...
    <section class="services" id="services">
        ...
        <div id="countdowm" class="countdown">
            <div class="time">
        ...
        <div class="max-width">
            <div class="contact-content">
                <div class="column left">
                    ...
                    <div class="text">
                        <span class="text-1">RAIMUNA CABANG III</span>
                        <span class="text-2">KOTA DEPOK</span><br>
                        <span class="text-3">2024</span>
                    </div>
                ...
                <div class="column right">
                    ...
                    <div class="row">
                        <div class="info-sosmed">
                            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=dkckotadepok@gmail.com&su=Raicab%20III%202024&body=Halo kaa," target="_blank"><img class="email" src="image/gmail.webp" alt="Email"></a>
                            <a href="https://www.instagram.com/dkc_kotadepok" target="_blank"><img  class="ig" src="https://cdn-icons-png.flaticon.com/128/2111/2111463.png" alt="Instagram"></a>
                        </div>
                    </div>
                </div>
                    <div class="container">
