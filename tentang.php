...
<body>
    ...
    <section class="home" id="beranda">
        <div class="max-width">
            <div class="home-content">
                ...
                <div class="text">
                    <span class="text-1">RAIMUNA CABANG III</span><br>
    ...
    <div class="wrapper swiper-wrapper">
        <div class="slide swiper-slide">
            <img src="image/datang1.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Kedatangan Peserta</span>
            </div>
        </div>
        <div class="slide swiper-slide">
            <img src="image/datang2.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Kedatangan Peserta</span>
        </div>
        </div>
        <div class="slide swiper-slide">
            <img src="image/buka1.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Pembukaan Raimuna Cabang II</span>
            </div>
        </div>
        <div class="slide swiper-slide">
            <img src="image/wn1.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Welcome Night</span>
            </div>
        </div>
        <div class="slide swiper-slide">
            <img src="image/wn2.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Welcome Night</span>
            </div>
        </div>
        <div class="slide swiper-slide">
            <img src="image/jumpa1.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Jumpa Tokoh</span>
            </div>
        </div>
        <div class="slide swiper-slide">
            <img src="image/jumpa2.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Jumpa Tokoh</span>
            </div>
        </div>
        <div class="slide swiper-slide">
            <img src="image/jumpa3.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Jumpa Tokoh</span>
            </div>
        </div>
        <div class="slide swiper-slide">
            <img src="image/jumpa4.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Jumpa Tokoh</span>
            </div>
        </div>
        <div class="slide swiper-slide">
            <img src="image/pentas1.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Pentas Seni</span>
            </div>
        </div>
        <div class="slide swiper-slide">
            <img src="image/pentas2.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Pentas Seni</span>
            </div>
        </div>
        <div class="slide swiper-slide">
            <img src="image/pentas3.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Pentas Seni</span>
            </div>
        </div>
        <div class="slide swiper-slide">
            <img src="image/spesial1.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Giat Spesial</span>
            </div>
        </div>
        <div class="slide swiper-slide">
            <img src="image/spesial2.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Giat Spesial</span>
            </div>
        </div>
        <div class="slide swiper-slide">
            <img src="image/lifeskill1.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Giat Life Skill</span>
            </div>
        </div>
        <div class="slide swiper-slide">
            <img src="image/lifeskill2.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Giat Life Skill</span>
            </div>
        </div>
        <div class="slide swiper-slide">
            <img src="image/wisata1.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Giat Wisata</span>
            </div>
        </div>
        <div class="slide swiper-slide">
            <img src="image/wisata2.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Giat Wisata</span>
            </div>
        </div>
        <div class="slide swiper-slide">
            <img src="image/wisata3.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Giat Wisata</span>
            </div>
        </div>
        <div class="slide swiper-slide">
            <img src="image/ekshibisi1.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Giat Ajang Ekshibisi</span>
            </div>
        </div>
        <div class="slide swiper-slide">
            <img src="image/ekshibisi2.webp" alt="" class="image" />
            <div class="image-data">
                <span class="text">Giat Ajang Ekshibisi</span>
            </div>
        </div>
